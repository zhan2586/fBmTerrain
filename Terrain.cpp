...
const glm::vec3 objectColor(1.0f, 0.0f, 1.0f);
...
void draw_gui()
{
	...
	int mode_loc = glGetUniformLocation(shader_program, "item_current");
	glUniform1i(mode_loc, item_current);
	...
	ImGui::SliderFloat("Lacunarity", &lacunarity, 0.0f, 16.0f);
...
void display()
{
	...
	drawString("Press a, z to move along Y axis.");
	drawString("Press UP, DOWN to move along Z axis.");
